...
function TeacherRoleCreateForm() {
  ...
  if (token) {
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
      ...
      const data = {
        ...
        try {
          const response = await teacherRoleServices.createTeacherRole(data, token);
          console.log("Success:", response.data);
          enqueueSnackbar("Teacher Role added successfully!", {
            variant: "success",
          ...
          if (error.response) {
              ...
              enqueueSnackbar("Error adding teacher role", { variant: "error" });
          }
      }
      ...
      return (
      <Box m="20px">
        <Header title="Teacher roles" subtitle="Create New Record" />
        <Formik
  ...
  export default TeacherRoleCreateForm;