...
function ExamTypeUpdateForm() {
  ...
  useEffect(() => {
    async function fetchExistingData() {
      try {
        const response = await examTypeServices.getExamTypeById(examTypeId, token);
  ...
  const mergedValues = { ...initialValues, ...existingData };
    ...
    const handleFormSubmit = async (values, { resetForm }) => {
      ...
      const data = {
        ...
        try {
          const response = await examTypeServices.updateExamType(examTypeId, data, token);
          console.log("Success:", response.data);
          enqueueSnackbar("Exam Type updated successfully!", {
            variant: "success",
          ...
          if (error.response) {
              ...
              enqueueSnackbar("Error updating exam type", { variant: "error" });
          }
      }
      ...
      return (
      <Box m="20px">
        <Header title="Exam types" subtitle="Update Existing Record" />
        <Formik
  ...
  export default ExamTypeUpdateForm;