...
import useService from "../../../hooks";
  ...
  function GroupSubjectUpdateForm() {
    ...
    useEffect(() => {
      ...
      useEffect(() => {
        async function fetchExistingData() {
          try {
            const response = await groupSubjectServices.getGroupSubjectById(groupSubjectId, token);
    ...
    //   });
      ...
      try {
        ...
        const response = await groupSubjectServices.updateGroupSubject( groupSubjectId, requestData, token );
    
        console.log("Success:", response.data);
        enqueueSnackbar("Group subject updated successfully!", {
          variant: "success",
        ...
        if (error.response) {
          ...
          enqueueSnackbar("Error updating group subject", { variant: "error" });
        }
      }
    };
    ...
    return (
      <Box m="20px">
      <Header title="Group subjects" subtitle="Update Existing Record" />
      <Formik
  ...
  export default GroupSubjectUpdateForm;